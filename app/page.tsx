  ...
  return (
    <main className="flex flex-col min-h-screen p-8">
      ...
      <section className="mt-8">
        ...
        <p className="mt-4 text-lg">
          The website is built using Next.js for the framework, Tailwind CSS for
          styling, and TypeScript for type safety. The repository is hosted on
          GitHub, and any push or merge to the main branch triggers a deployment
          on Vercel.
        </p>
      </section>
      <section className="mt-8">
        ...
        <p className="mt-4 text-lg">
          ...
          addresses, and protocols. The domain name system (DNS) translates the
          domain name to an IP address, allowing users to access the site via
          the subdomain.
        </p>
      </section>
      <section className="mt-8">
        ...
        <p className="mt-4 text-lg">
          Some challenges faced during the project included configuring the DNS
          settings and ensuring the CI/CD pipeline was correctly set up. These
          were resolved by referring to Vercel and GitHub documentation.
        </p>
      </section>
      <section className="mt-8">
